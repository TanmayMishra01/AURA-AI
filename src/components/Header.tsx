...
export const Header: React.FC<HeaderProps> = ({ apiKeyConfigured = true }) => {
  return (
    <header className="px-5 py-4 flex justify-between items-center border-b border-[#333] bg-[#1a1a1a]/90 backdrop-blur sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 text-xs text-gray-400 bg-[#252525] px-3 py-1.5 rounded-full border border-[#383838]">
          <span
          ...
          <span className="hidden sm:inline">
            {apiKeyConfigured ? "Gemini Engine Ready" : "API Setup Required"}
          </span>
          <span className="sm:hidden">
            {apiKeyConfigured ? "Ready" : "Setup"}
          </span>
        </div>
